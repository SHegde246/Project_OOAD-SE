...
class Post(models.Model):
    ...
    user = models.ForeignKey(User, on_delete=models.CASCADE, null=True,related_name='assimilate_user')
...
class EditLogs(models.Model):
	user = models.ForeignKey(User, on_delete=models.CASCADE, null=True, related_name='assimilate_editlogs_user')
